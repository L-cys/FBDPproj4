...
public class PopularItemMR {
    public static class PopularItemMapper extends Mapper<Object, Text, Text, IntWritable> {
        Text k = new Text();
    ...
    public static void main(String args[]) throws Exception {
        ...
        jobOne.setJarByClass(PopularItemMR.class);
        jobOne.setMapperClass(PopularItemMapper.class);
